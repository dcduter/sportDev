...
const Sidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView, onLogout }) => {
  const menuItems = [
    ...
    { id: 'training', icon: 'fitness_center', label: 'Plan de Entrenamiento' },
    { id: 'workout', icon: 'play_circle', label: 'Empezar Entrenamiento' },
    { id: 'routines', icon: 'list_alt', label: 'Mis Rutinas' }, // Added My Routines
    { id: 'library', icon: 'menu_book', label: 'Librería de Ejercicios' },
    { id: 'progress', icon: 'monitoring', label: 'Progreso' },
    { id: 'goals', icon: 'target', label: 'Objetivos' },
    { id: 'gamification', icon: 'military_tech', label: 'Logros' },
    { id: 'community', icon: 'group', label: 'Comunidad' },
    { id: 'wellness', icon: 'self_improvement', label: 'Bienestar y Recuperación' },
  ];
